...
Los efectos arcade, salvo explosión y alarma, proceden del paquete CC0 **Interface Sounds** de Kenney. Captura de peces: nota corta; basura: cristal; botones: clic, confirmación y error distintos. Pez globo, caracoles, niveles y poderes tienen señales propias. Las capturas y clics varían ligeramente su tono para evitar una repetición idéntica.

Los robots, la llegada de caracoles y las explosiones usan fuentes 3D. La alarma original FNAF 3 ventilation error nace junto al botón inferior y tiene su propio reproductor, sin competir con otros efectos. Los caracoles no emiten sonido continuamente mientras están pegados al cristal.
...
2. Ajusta **Music Volume Db** (predeterminado -7) y **Ambience Volume Db** (-22).
...
Los detalles, nombres originales y archivos de licencia están en `assets/audio/arcade/licenses`. El motor es síntesis propia. Por petición del autor del proyecto se restauraron deltarune-explosion.mp3 y FNAF 3 ventilation error.mp3, copiados sin modificación desde sus archivos originales a assets/audio/restored para incluirlos en las exportaciones futuras. No se atribuye licencia CC0 a estos dos audios. Los demás archivos antiguos siguen conservados y excluidos.
...
## Mezcla para demostraciones con público

Música +13 dB respecto a la mezcla anterior; efectos generales a -6 dB, interfaz a -5 dB y alarma a -4 dB. Los robots quedan 6 dB por debajo del resto de efectos. Las fuentes 3D usan unit_size=5 para evitar que la distancia las vuelva casi inaudibles en la cabina. La reducción temporal de música baja de 6 a 3 dB.

En SoundHub puedes ajustar Effects Volume Db, Interface Volume Db, Alarm Volume Db y Pitch Variation Semitones (1.6). Los efectos repetidos evitan tonos consecutivos casi iguales; la explosión varía menos y la alarma conserva el tono original. Master mantiene el limitador de -1 dB. El volumen final también depende del volumen del visor.
